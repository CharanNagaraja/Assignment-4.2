...
public class Shirt {
	...
	Shirt(int shirtCollarSize, int shirtSleeveLength) {  //a constructor for that accepts arguments for the collar size and sleeve length
		...
		material = "Denim";   //constructor can set the material to cotton for all objects by using the following code: material = "Cotton"
	}
	...
	public String toString(){  // add another public method to Shirt that prints all the information required.
		return "Shirt Size : " + getShirtCollarSize() + " Shirt Sleeve Length : " +getShirtSleeveLength()+" Material Quality :"+ getMaterial();
	}
